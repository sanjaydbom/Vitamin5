...
/*
 * GCC gives a warning for comparing "nonnull" strings, even though they
 * are not marked as "nonnull" in the Pintos code. Perhaps the compiler
 * has a built-in definition that includes "nonnull"? In any case,
 * I'm ignoring the warning here.
 */
